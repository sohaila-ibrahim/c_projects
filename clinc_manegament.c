/************************************************************/
/* AUTHOR      : SOHAILA  IBRAHIM MOHAMMEDED                           */
...
//finally this function To reserve 
void Reservation (u16 key, u8 choice ); 
//this function To cancel Reservation 
void CancelReserv (u16 key,u8 choice);
//this function specified for the user display  
...
void AddNode (void)
{
	...
	if (ptr!=NULL)
	{
		...
		{
			printf("This ID Is Already Exist 0_0 \n");
		}
	}
}
/*
...
/*
10-Canceling Reservation Function 
*/
void CancelReserv (u16 key,u8 choice)
{
	struct paitent * ptr;
